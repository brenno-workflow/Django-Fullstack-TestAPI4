...
# Importar os para informar os diretorios
import os
...
SECRET_KEY = 'django-insecure-qehmo(cs*#83d5+w%o8fx6uh))_gd^6cw0!fsh*^%cvk-86n@1'
...
INSTALLED_APPS = [
    ...
    # Adiconar as pastas dos aplicativos
    'curriculum42',
    'accounts',
    #'resumes',
]
...
TEMPLATES = [
    {
        ...
        # Informar o diretorio do templstes (frontend)
